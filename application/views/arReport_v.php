...
<!-- Content Header (Page header) -->
 <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Annual Review Report</li>
          </ol>
        </section>
        <!-- Main Content -->
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
             ...
             <span class="fa fa-question-circle"></span> Download Annual Review Report</h3>
            </div>
            <form class="form-signin" action="ArReport/arReportProcess" name="form1" id="form1" method="post">
